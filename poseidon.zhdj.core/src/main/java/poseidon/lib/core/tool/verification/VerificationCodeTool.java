package poseidon.lib.core.tool.verification;
...
public class VerificationCodeTool {
	 ...
	 * @return
	 */
	public static VerificationCodeTool Instance() {
		return new VerificationCodeTool();
	}
	...
	public static void main(String[] arg) {
		VerificationCodeTool vcu = VerificationCodeTool.Instance();
